 ...
 *
 * Description:
 * Include file for editing content of type CMS_MIUTEXTILE.
 *
...
$options = array(
    'markup_name'  => 'textile',
    'cmstype_name' => 'CMS_MIUTEXTILE',
    'parser_file'  => 'class.markup_textile_parser.php',
    'parser_name'  => 'Markup_TextileParser',
);
...
if ($doedit == '1') {
    ...
    $oMarkUpEditing->save($CMS_MIUTEXTILE);
