 ...
 *
 * ElephantMarkdown
 * by Alexandre Gaigalas http://gaigalas.net
 * https://github.com/alganet/ElephantMarkdown
 *
 * forked from the php-markdown project by Michel Fortin http://www.michelf.com/
 *
 * Additional features and fixes by Henrik Paul http://github.com/wolfie/php-markdown/tree/extra
 *
 * based on Markdown by John Gruber
 * http://daringfireball.net/
 *
 * Adapted to some requirements by Murat Purc
 */
...
class Markdown_Parser extends ElephantMarkdown
{
}
...
class ElephantMarkdown
{
    ...
    public function doHorizontalRules($text)
    {
        ...
        return preg_replace(
            ...
            "\n" . $this->hashBlock("<hr" . PI_MARKITUP_TAGEND) . "\n", $text);
    }
    ...
    {
        return $this->hashPart("<br" . PI_MARKITUP_TAGEND . "\n");
    }
    ...
    {
        return str_repeat("<br" . PI_MARKITUP_TAGEND, strlen($matches[0]));
    }
